...
public partial class ModelContext : DbContext
{
    ...
    public virtual DbSet<BerlesVasarla> BerlesVasarlas { get; set; }

    public virtual DbSet<Esemenyek> Esemenyeks { get; set; }

    public virtual DbSet<EseményResztvevok> EseményResztvevoks { get; set; }
    ...
    public virtual DbSet<Raktarak> Raktaraks { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseOracle("User Id=system;Password=System123;Data Source=localhost:1521/xe");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<BerlesVasarla>(entity =>
        {
            entity.HasKey(e => e.TranzakcioId);

            entity.ToTable("Berles_Vasarlas");

            entity.HasIndex(e => e.FelhasznaloId, "IX_Berles_Vasarlas_FelhasznaloId");

            entity.HasIndex(e => e.RaktarId, "IX_Berles_Vasarlas_RaktarId");

            entity.Property(e => e.TranzakcioId).HasPrecision(10);
            entity.Property(e => e.Ar).HasColumnType("NUMBER(18,2)");
            entity.Property(e => e.FelhasznaloId).HasPrecision(10);
            entity.Property(e => e.KezdesDatum).HasPrecision(7);
            entity.Property(e => e.RaktarId).HasPrecision(10);
            entity.Property(e => e.VegDatum).HasPrecision(7);

            entity.HasOne(d => d.Felhasznalo).WithMany(p => p.BerlesVasarlas).HasForeignKey(d => d.FelhasznaloId);

            entity.HasOne(d => d.Raktar).WithMany(p => p.BerlesVasarlas).HasForeignKey(d => d.RaktarId);
        });

        modelBuilder.Entity<Esemenyek>(entity =>
        {
            entity.HasKey(e => e.Esemenyid);

            entity.ToTable("Esemenyek");

            entity.Property(e => e.Esemenyid)
                .HasPrecision(10)
        ...
        modelBuilder.Entity<EseményResztvevok>(entity =>
        {
            entity.HasKey(e => e.ResztvevoId);

            entity.ToTable("Esemény_Resztvevok");

            entity.HasIndex(e => e.EsemenyId, "IX_Esemény_Resztvevok_EsemenyId");

            entity.HasIndex(e => e.FelhasznaloId, "IX_Esemény_Resztvevok_FelhasznaloId");

            entity.Property(e => e.ResztvevoId).HasPrecision(10);
            entity.Property(e => e.EsemenyId).HasPrecision(10);
            entity.Property(e => e.FelhasznaloId).HasPrecision(10);

            entity.HasOne(d => d.Esemeny).WithMany(p => p.EseményResztvevoks).HasForeignKey(d => d.EsemenyId);

            entity.HasOne(d => d.Felhasznalo).WithMany(p => p.EseményResztvevoks).HasForeignKey(d => d.FelhasznaloId);
        });
        ...
        modelBuilder.Entity<Felhasznalok>(entity =>
        {
            ...
            entity.Property(e => e.SzuletesiDatum).HasPrecision(7);
            entity.Property(e => e.SzuletesiHely).HasMaxLength(100);
            entity.Property(e => e.TemaSzine).HasMaxLength(7);
        });
        ...
        modelBuilder.Entity<Raktarak>(entity =>
        {
            entity.HasKey(e => e.RaktarId);

            entity.ToTable("Raktarak");

            entity.HasIndex(e => e.TulajdonosId, "IX_Raktarak_TulajdonosId");

            entity.Property(e => e.RaktarId).HasPrecision(10);
            entity.Property(e => e.ArBerles).HasColumnType("NUMBER(18,2)");
            entity.Property(e => e.ArVetel).HasColumnType("NUMBER(18,2)");
            entity.Property(e => e.Cim).HasMaxLength(255);
            entity.Property(e => e.RaktarSzam).HasMaxLength(50);
            entity.Property(e => e.TulajdonosId).HasPrecision(10);

            entity.HasOne(d => d.Tulajdonos).WithMany(p => p.Raktaraks).HasForeignKey(d => d.TulajdonosId);
        });
